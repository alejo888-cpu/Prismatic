    ...
    return (
        <section id="que-hacemos" className="section-padding bg-white">
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                ...
                >
                    <h2 className="text-4xl md:text-5xl leading-tight mb-6" style={{ color: "var(--dark)" }}>
                        Transformamos ideas en{" "}
                        <span style={{ color: "var(--green-accent)" }}>espacios vivos</span>
                    </h2>
                    <p className="text-gray-500 leading-relaxed mb-8">
                        En Prismatic, creemos que cada espacio exterior tiene el potencial de
                        convertirse en un oasis de tranquilidad y belleza. Nuestro equipo de
                        expertos en paisajismo trabaja contigo para diseñar y crear jardines
                        que reflejen tu visión y respeten el medio ambiente.
                    </p>
...
export function Conocenos() {
    return (
        <section id="conocenos" className="section-padding" style={{ background: "var(--cream)" }}>
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                <motion.div
                    initial={{ opacity: 0, x: -30 }}
                    whileInView={{ opacity: 1, x: 0 }}
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl mb-6" style={{ color: "var(--dark)" }}>
                        Conócenos
                    </h2>
                    <div className="space-y-4 text-gray-600 leading-relaxed">
                        <p>
                            Somos un equipo{" "}
                            <strong style={{ color: "var(--dark)" }}>apasionado por el paisajismo</strong> y
                            la sostenibilidad, dedicado a transformar espacios ordinarios en
                            extraordinarios ecosistemas verdes.
                        </p>
                        <p>
                            Con años de experiencia en diseño de jardines y arquitectura del
                            paisaje, combinamos{" "}
                            <strong style={{ color: "var(--green-accent)" }}>creatividad</strong>, conocimiento
                            técnico y un profundo{" "}
                            <strong style={{ color: "var(--green-accent)" }}>respeto por la tierra</strong> para
                            crear espacios que no solo son hermosos, sino también funcionales y
                            ecológicamente responsables.
                        </p>
                        <p>
                            Desde pequeños jardines urbanos hasta grandes proyectos comerciales,
                            cada proyecto es una oportunidad para conectar a las personas con la
                            naturaleza y crear entornos que inspiran paz y bienestar.
                        </p>
                    </div>
                </motion.div>
            </div>
